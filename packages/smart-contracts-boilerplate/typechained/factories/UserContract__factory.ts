...
type UserContractConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: UserContractConstructorParams): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;
...
export class UserContract__factory extends ContractFactory {
  ...
  deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<UserContract> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): UserContract {
