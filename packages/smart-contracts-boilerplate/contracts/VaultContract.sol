...
contract VaultContract {
    ...
    function borrowKhooleeCoins(uint256 borrowAmount) public {
        ...
        uint256 maxAmountThatCanBeBorrowed = userCollateral[msg.sender] * getMockOtUSDValue() * LOAN_TO_VALUE / LOAN_TO_VALUE_PRECISION / 10;
    ...
    function returnHealthFactor() public view returns(uint256) {
        ...
        uint256 a = percent(userCollateral[msg.sender] * getMockOtUSDValue() * percent(LIQUIDATION_THRESHOLD, LIQUIDATION_THRESHOLD_PRECISION, 2), userBorrowed[msg.sender] * 100 , 2) / 10;
        return a;
