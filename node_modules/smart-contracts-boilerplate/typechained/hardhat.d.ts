...
declare module 'hardhat/types/runtime' {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(name: 'ERC20Burnable', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.ERC20Burnable__factory>;
    getContractFactory(name: 'ERC20Pausable', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.ERC20Pausable__factory>;
    ...
    getContractFactory(
      name: 'KhooleeCoinMinter',
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.KhooleeCoinMinter__factory>;
    getContractFactory(name: 'MockOT', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.MockOT__factory>;
    getContractFactory(
      name: 'KhooleeCoinMinterInterface',
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.KhooleeCoinMinterInterface__factory>;
    getContractFactory(name: 'MockOTInterface', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.MockOTInterface__factory>;
    getContractFactory(name: 'VaultContract', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.VaultContract__factory>;

    getContractAt(name: 'AccessControl', address: string, signer?: ethers.Signer): Promise<Contracts.AccessControl>;
    getContractAt(name: 'AccessControlEnumerable', address: string, signer?: ethers.Signer): Promise<Contracts.AccessControlEnumerable>;
    getContractAt(name: 'IAccessControl', address: string, signer?: ethers.Signer): Promise<Contracts.IAccessControl>;
    getContractAt(name: 'IAccessControlEnumerable', address: string, signer?: ethers.Signer): Promise<Contracts.IAccessControlEnumerable>;
    ...
    getContractAt(name: 'ERC20PresetMinterPauser', address: string, signer?: ethers.Signer): Promise<Contracts.ERC20PresetMinterPauser>;
    ...
    getContractAt(name: 'KhooleeCoinMinter', address: string, signer?: ethers.Signer): Promise<Contracts.KhooleeCoinMinter>;
    getContractAt(name: 'MockOT', address: string, signer?: ethers.Signer): Promise<Contracts.MockOT>;
    getContractAt(name: 'KhooleeCoinMinterInterface', address: string, signer?: ethers.Signer): Promise<Contracts.KhooleeCoinMinterInterface>;
    getContractAt(name: 'MockOTInterface', address: string, signer?: ethers.Signer): Promise<Contracts.MockOTInterface>;
    getContractAt(name: 'VaultContract', address: string, signer?: ethers.Signer): Promise<Contracts.VaultContract>;
